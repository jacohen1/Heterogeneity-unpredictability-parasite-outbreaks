...
to setup-turtles
  create-snaves carrying-capacity * (1 - proportion-dorris)
  create-dorrises carrying-capacity * proportion-dorris
  ask turtles [
  ...
  ask turtles [
    ...
    if length par-list > day-length [
      ...
      if breed = snaves [
        ...
        let parasites random-binomial first par-list susc-value-snave
      ...
      if breed = dorrises [
        ;create value for binomial distribution of parasites establishing, n = uptake, p = susceptibility
        let parasites random-binomial first par-list susc-value-dorris
        set inf (inf + parasites)
        ;the parasite is lost from the beetle's par-list
        set par-list but-first par-list
      ]
